<html>
    ...
    <body>
        ...
        <div id="admin-cont" style="position:absolute;top:100%;">
            <img src = "assets/user.png"style="position:relative;width:40%;height:80%;top:9%;"></img>
            <p id="welcome-admin" style="position:relative;top:-67%;font-size:1.2em;left:45%;">Welcome,</p>
            <h1 id="welcome-admin-2" style="position:relative;top:-86%;font-size:2.7em;left:45%;">Admin!</h1>
    </div>
