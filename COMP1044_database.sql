...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2023 at 10:57 AM
...
INSERT INTO `car` (`car_type_id`, `car_model`, `car_colour`, `rental_per_day`, `availability`) VALUES
(1, 'Bentley Continental Flying Spur', 'White', '4800', 'available'),
(2, 'Ferrari F430 Scuderia', 'Red', '6000', 'available'),
(3, 'Jaguar MK 2', 'White', '2200', 'available'),
(1, 'Jaguar S Type', 'Champagne', '1350', 'available'),
(2, 'Lamborghini Murcielago LP640', 'Matte Black', '7000', 'available'),
(2, 'Lexus SC430', 'Black', '1600', 'available'),
(1, 'Mercedes Benz CLS 350', 'Silver', '1350', 'available'),
(3, 'MG TD', 'Red', '2500', 'available'),
(2, 'Porsche Boxster', 'White', '2800', 'available'),
(1, 'Rolls Royce Phantom', 'Blue', '9800', 'available'),
(3, 'Rolls Royce Silver Spirit Limousine', 'Georgian Silver', '3200', 'available');
