<?php
    ...
    // $mysqlcheckdate = mysqli_query($conn, "SELECT * FROM reservation WHERE car_id='$car_id' AND ((rental_date_start <= '$rentalstartdate' AND rental_date_end >= '$rentalstartdate') OR (rental_date_start <= '$rentalenddate' AND rental_date_end >= '$rentalenddate') OR (rental_date_start >= '$rentalstartdate' AND rental_date_end <= '$rentalenddate'))");
